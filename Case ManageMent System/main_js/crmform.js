  ...
  let dd = json;
      ...
      cls.setForwardList = result;               
        ...
        for (let item of result) {
            ...
            rawHTML += `<li class="chetan-userlistClick" name="${item.Folder}" id="${item.FolderID}">
                                            <div class="timeline-panel">
                                            <i style="font-size:22px; width:32px; color:#0D99FF;padding-right: 15px;" class="bi bi-wallet2 hidedata_sonam" id=""></i>
                                                <div class="media-body">
                                                    <h5 class="mb-1">${item.Folder}</h5>
        ...
        $("#chetan-folder-list").html(rawHTML);
...
obj.ProjectId = GetProjectId;
  ...
  // obj.SectionId = "-1";
  cls.Json_GetClientsByFolder(obj, function (status, Data) {
      if (status) {
          var json = Data['Table1'];
  ...
  let dd = json;
      ...
      cls.setClientsList = result;               
        ...
        for (let item of result) {
            ...
            rawHTML += `<li class="reference-userlistClick" name="${item.Client}" id="${item.ClientID}">
                                            <div class="timeline-panel">
                                            <i style="font-size:22px; width:32px; color:#0D99FF;padding-right: 15px;" class="bi bi-person hidedata_sonam" id=""></i>
                                                <div class="media-body">
        ...
        $("#test-reference-list").html(rawHTML);
...
$("#folder-list-search-input").keyup(function(){
  let value = $("#folder-list-search-input").val();
  allFolders = cls.setForwardList;
  let filteredData = allFolders.filter((item)=>{
...
$("#reference-list-search-input").keyup(function(){
  let value = $("#reference-list-search-input").val();
  allFolders = cls.setForwardList;
  let filteredData = allFolders.filter((item)=>{
    return Object.values(item).join('').toLowerCase().includes(value.toLowerCase());
  });
  let rawHTML = "";
  filteredData.map((item)=>{
    rawHTML += `<li class="reference-userlistClick" name="${item.Folder}" id="${item.FolderID}">
                                            <div class="timeline-panel">
                                            <i style="font-size:22px; width:32px; color:#0D99FF;padding-right: 15px;" class="bi bi-wallet2 hidedata_sonam" id=""></i>
                                                <div class="media-body">
                                                    <h5 class="mb-1">${item.Folder}</h5>
...
$(document).on("click", ".reference-userlistClick", function () {
  let gid = $(this).attr('id');
...
color: white;">${initials}</span>`);
  ...
  $("#" + gid).hide();
   ...
   $(document).on("click", ".chetan-userlistClick", function () {
      let gid = $(this).attr('id');
...
function GetSections() {
  ...
  obj.ProjectId = GetProjectId;
  // obj.SectionId = "-1";
  cls.Json_GetSections(obj, function (status, Data) {
      if (status) {
          var json = Data['Table'];

          console.log('Json_GetSections  ', json);
  // cls.setForwardUser = json;
  let dd = json;
      ...
      cls.setForwardList = result;               
        ...
        for (let item of result) {
            ...
            rawHTML += `<li class="section-userlistClick" name="${item.Sec}" id="${item.SecID}">
                                            <div class="timeline-panel">
                                            <i style="font-size:22px; width:32px; color:#0D99FF;padding-right: 15px;" class="fa fa-pie-chart hidedata_sonam" id=""></i>
                                                <div class="media-body">
                                                    <h5 class="mb-1">${item.Sec}</h5>
        ...
        $("#test-section-list").html(rawHTML);
...
$("#section-list-search-input").keyup(function(){
  let value = $("#section-list-search-input").val();
  allFolders = cls.setForwardList;
  let filteredData = allFolders.filter((item)=>{
    return Object.values(item).join('').toLowerCase().includes(value.toLowerCase());
  });
  let rawHTML = "";
  filteredData.map((item)=>{
    rawHTML += `<li class="section-userlistClick" name="${item.Folder}" id="${item.FolderID}">
                                            <div class="timeline-panel">
                                            <i style="font-size:22px; width:32px; color:#0D99FF;padding-right: 15px;" class="fa fa-pie-chart hidedata_sonam" id=""></i>
                                                <div class="media-body">
                                                    <h5 class="mb-1">${item.Folder}</h5>
...
$(document).on("click", ".section-userlistClick", function () {
  let gid = $(this).attr('id');
...
function GetStatus() {
  ...
  let dd = json;
      ...
      cls.setForwardList = result;               
        ...
        for (let item of StatusData1) {
            count++;
            let no = "success";
            if (count % 2 == 0) {
                no = "warning";
            }
            rawHTML += `<li class="status-userlistClick" name="${item.Status}" id="${item.Status}">
                                            <div class="timeline-panel">
                                            <i style="font-size:22px; width:32px; color:#0D99FF;padding-right: 15px;" class="bi bi-wallet2 hidedata_sonam" id=""></i>
                                                <div class="media-body">
...
$("#status-list-search-input").keyup(function(){
  let value = $("#status-list-search-input").val();
  allFolders = cls.setForwardList;
  let filteredData = allFolders.filter((item)=>{
    return Object.values(item).join('').toLowerCase().includes(value.toLowerCase());
  });
  let rawHTML = "";
  filteredData.map((item)=>{
    rawHTML += `<li class="status-userlistClick" name="${item.Folder}" id="${item.FolderID}">
                                            <div class="timeline-panel">
                                            <i style="font-size:22px; width:32px; color:#0D99FF;padding-right: 15px;" class="bi bi-wallet2 hidedata_sonam" id=""></i>
                                                <div class="media-body">
                                                    <h5 class="mb-1">${item.Folder}</h5>
...
$(document).on("click", ".status-userlistClick", function () {
  let gid = $(this).attr('id');
  ...
  let dd = json;
      ...
      cls.setForwardList = result;               
        ...
        for (let item of PriorityData) {
            ...
            rawHTML += `<li class="priority-userlistClick" name="${item.Priority}" id="${item.PriorityID
            }">
                                            <div class="timeline-panel">
                                            <i style="font-size:22px; width:32px; color:#0D99FF;padding-right: 15px;" class="bi bi-wallet2 hidedata_sonam" id=""></i>
                                                <div class="media-body">
                                                    <h5 class="mb-1">${item.Priority}</h5>
        ...
        $("#test-priority-list").html(rawHTML);
...
function GetComplete() {
  ...
  let dd = json;
      ...
      cls.setForwardList = result;               
        ...
        // }
        $("#test-complete-list").html(rawHTML);
...
$("#priority-list-search-input").keyup(function(){
  ...
  let rawHTML = "";
  filteredData.map((item)=>{
    rawHTML += `<li class="priority-userlistClick" name="${item.Folder}" id="${item.FolderID}">
                                            <div class="timeline-panel">
                                            <i style="font-size:22px; width:32px; color:#0D99FF;padding-right: 15px;" class="bi bi-wallet2 hidedata_sonam" id=""></i>
                                                <div class="media-body">
                                                    <h5 class="mb-1">${item.Folder}</h5>
...
$(document).on("click", ".priority-userlistClick", function () {
  let gid = $(this).attr('id');
...
function GetOwner() {
  ...
  obj.ProjectId = GetProjectId;
  // obj.SectionId = "-1";
  cls.Json_Get_CRM_UserByProjectId(obj, function (status, Data) {
      if (status) {
          var json = Data['Table'];
  ...
  let dd = json;
      ...
      cls.setForwardList = result;               
        ...
        for (let item of result) {
            ...
            rawHTML += `<li class="owner-userlistClick" name="${item.DisplayName}" id="${item.DSUserID}">
                                            <div class="timeline-panel">
                                            <i style="font-size:22px; width:32px; color:#0D99FF;padding-right: 15px;" class="bi bi-person  hidedata_sonam" id=""></i>
                                                <div class="media-body">
...
$("#owner-list-search-input").keyup(function(){
  let value = $("#owner-list-search-input").val();
  allFolders = cls.setForwardList;
  let filteredData = allFolders.filter((item)=>{
    return Object.values(item).join('').toLowerCase().includes(value.toLowerCase());
  });
  let rawHTML = "";
  filteredData.map((item)=>{
    rawHTML += `<li class="owner-userlistClick" name="${item.Folder}" id="${item.FolderID}">
                                            <div class="timeline-panel">
                                            <i style="font-size:22px; width:32px; color:#0D99FF;padding-right: 15px;" class="bi bi-wallet2 hidedata_sonam" id=""></i>
                                                <div class="media-body">
                                                    <h5 class="mb-1">${item.Folder}</h5>
...
$(document).on("click", ".owner-userlistClick", function () {
  let gid = $(this).attr('id');
...
color: white;">${initials}</span>`);
  ...
  usernameArray_owner.push(object);
  // console.log(usernameArray_sec, "usernameArray_sec ");
  ...
  let dd = json;
      ...
      cls.setForwardList = result;               
        ...
        for (let item of result) {
            ...
            rawHTML += `<li class="assignee-userlistClick" name="${item.ForwardTo}" id="${item.ID}">
                                            <div class="timeline-panel">
                                            <i style="font-size:22px; width:32px; color:#0D99FF;padding-right: 15px;" class="bi bi-person hidedata_sonam" id=""></i>
                                                <div class="media-body">
                                                    <h5 class="mb-1">${item.ForwardTo}</h5>
        ...
        $("#test-assignee-list").html(rawHTML);
...
$("#assignee-list-search-input").keyup(function(){
  let value = $("#assignee-list-search-input").val();
  allFolders = cls.setForwardList;
  let filteredData = allFolders.filter((item)=>{
    return Object.values(item).join('').toLowerCase().includes(value.toLowerCase());
  });
  let rawHTML = "";
  filteredData.map((item)=>{
    rawHTML += `<li class="assignee-userlistClick" name="${item.Folder}" id="${item.FolderID}">
                                            <div class="timeline-panel">
                                            <i style="font-size:22px; width:32px; color:#0D99FF;padding-right: 15px;" class="bi bi-wallet2 hidedata_sonam" id=""></i>
                                                <div class="media-body">
                                                    <h5 class="mb-1">${item.Folder}</h5>
...
$(document).on("click", ".assignee-userlistClick", function () {
  let gid = $(this).attr('id');
