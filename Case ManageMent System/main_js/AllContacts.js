...
$(document).ready(function () {
  var windowHeight = window.innerHeight + "px";
    $("#dxDataGridAllContacts").css("height", windowHeight);
...
$(document).on("click", "#createRequest_button", function () {
  ...
  function showContactsById(getdata) {
    ...
    var grid = new DevExpress.ui.dxDataGrid(document.getElementById("dxDataGridAllContacts"), gridOptions);
...
//   function showContactsById(GetData) {
//     dxAllcontacts = $("#dxDataGridAllContacts")
//       .dxDataGrid({
//         dataSource: GetData,
...
//       .dxDataGrid("instance");
//   }
function showContacts_data(GetData) {
  for(let item of GetData){
    $("#dxDataGridAllContacts_data").append(`
